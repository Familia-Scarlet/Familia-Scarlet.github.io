...
setTimeout(fn,0)
console.log(2)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上的3条函数都是在同步队列中的任务，同步队列的任务依次放到执行任务队列中执行，当执行到setTimeout函数时候会向异步队列中添加异步任务。同步任务执行完毕后，再查看异步队列中是否有任务，如果有就将异步任务依次加入到任务队列中进行执行。</p><p><img src="`+d+'" alt="截图_20230610003732"></p><h2 id="promise对象" tabindex="-1"><a class="header-anchor" href="#promise对象" aria-hidden="true">#</a> Promise对象</h2>',121),t=[s];function r(c,p){return i(),a("div",null,t)}const u=e(l,[["render",r],["__file","js笔记.html.vue"]]);export{u as default};
