...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>jsx语法要通过babel编译处理后变成原生的js语法，然后就可以在浏览器中运行了。</p><h3 id="jsx语法注意点" tabindex="-1"><a class="header-anchor" href="#jsx语法注意点" aria-hidden="true">#</a> JSX语法注意点</h3><ol><li>React元素的==属性名==使用驼峰命名法</li><li>特殊属性名，如className、htmlFor、tabIndex</li><li>没有子节点的react元素可以用<code>/&gt;</code>结束</li><li>推荐使用小括号<code>()</code>包裹JSX语法</li></ol><h2 id="jsx语法" tabindex="-1"><a class="header-anchor" href="#jsx语法" aria-hidden="true">#</a> JSX语法</h2><h3 id="插值表达式" tabindex="-1"><a class="header-anchor" href="#插值表达式" aria-hidden="true">#</a> 插值表达式</h3><p>类似vue，但是，是使用==单==花括号<code>{}</code></p><p>花括号内可以使用js表达式，也可以使用函数表达式</p><h3 id="条件渲染" tabindex="-1"><a class="header-anchor" href="#条件渲染" aria-hidden="true">#</a> 条件渲染</h3><h3 id="列表渲染" tabindex="-1"><a class="header-anchor" href="#列表渲染" aria-hidden="true">#</a> 列表渲染</h3><p>使用数组中的map函数</p><p>和vue一样，列表渲染时候要设置好id，而且不能使用索引号作为id，因为id是可变的</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>const list = {
	&lt;ul&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,70),l=[d];function s(r,c){return i(),t("div",null,l)}const u=e(n,[["render",s],["__file","React笔记.html.vue"]]);export{u as default};
