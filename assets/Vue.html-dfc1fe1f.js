...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="项目结构的梳理" tabindex="-1"><a class="header-anchor" href="#项目结构的梳理" aria-hidden="true">#</a> 项目结构的梳理</h2><p>component和view都是放组件的，但view目录是放需要通过路由切换加载出来的组件。</p><h2 id="遗漏的课程内容" tabindex="-1"><a class="header-anchor" href="#遗漏的课程内容" aria-hidden="true">#</a> 遗漏的课程内容</h2><p>第8天--P204~P226</p><p>第5天--P127~P144</p>`,386);function q(k,w){return a(),d("div",null,[g,e("ol",x,[e("li",null,[e("mark",null,t(),1),l("：插值表达式，只能用在内容，不能用在属性，数据驱动视图，一般是占位符，不会覆盖默认内容")])]),f])}const y=n(h,[["render",q],["__file","Vue.html.vue"]]);export{y as default};
